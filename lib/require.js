  ...
  (function(require, exports, moduleId) {
            ...
            var onEvent=function () {
              ...
              if(element.listeners[e.type]) {
                ...
                for(var i=0;i < l;i++) {
                  ...
                  if(!element.listeners[e.type]) {
                    break;
                  } else if(l > element.listeners[e.type].length) {
        ...
        try {
          for(eventName in events) {
            ...
            if(eventName === 'Event') {
              ...
              this.eventNameToEventClassNameMap.webKitAnimationEnd=eventType;
    ...
    var PublisherType = (function() {
      function PublisherType() {
        ...
        var p_vars = new privateData();
        var depth = p_vars.depth;
        Object.getOwnPropertyDescriptor(this,'depth') || Object.defineProperty(this,'depth', {get: function(){return depth;},set: function(e){depth=e;}});
      ...
      PublisherType.prototype['cleanup'] = function(index) {
        return index?this.cleanupArray[index]:this.cleanupArray;
      };
      PublisherType.prototype['dispose'] = function() {
        this.cleanupArray=[];
      };
      PublisherType.prototype['doPublish'] = function(tree,path,index,name,msg) {
      ...
      PublisherType.prototype['pubDepth'] = function(value) {
        this.depth+=value?value:0;
        return this.depth;
      };
      PublisherType.prototype['publish'] = function(name,message) {
        var path=name.split(".");
        this.pubDepth(1);
        this.doPublish(Subscriber.subscriptions,path,0,name,message);
        this.pubDepth(-1);
        if((this.cleanup().length > 0) && (this.depth === 0)) {
      ...
      return function __() {
        var args = Array.prototype.slice.call(arguments);
        __.constructor = PublisherType;
        return new PublisherType(args && args.length && args[0]);
      };
    })();
    const Publisher=PublisherType();
...
(function() {
  ...
  (function(require, exports, moduleId) {
    ...
    var ControllerType = (function() {
      ...
      return function __() {
        var args = Array.prototype.slice.call(arguments);
        __.constructor = ControllerType;
        return new ControllerType(args && args.length && args[0]);
      };
    })();
  ...
  (function(require, exports, moduleId) {
    ...
    var Loader = (function() {
      ...
      return function __() {
        ...
        __.constructor = Loader;
        return new Loader(args && args.length && args[0]);
      };
    })();
