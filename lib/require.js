...
(function() {
  ...
  (function(require, exports, moduleId) {
    ...
    var Event = (function() {
      ...
      Event.prototype['addSubscriber'] = function() {
      ...
      Event.prototype['addSubscriberToEvent'] = function(type,callback,useCapture,element) {
      ...
      Event.prototype['addSubscriberToChannel'] = function(type,callback) {
        try {
      ...
      Event.prototype['bind'] = function(obj,fnc,ele) {
        var object=obj;
        var method=fnc;
        var element=ele;
        return function (e) {
      ...
      Event.prototype['fireEvent'] = function(element,type,name) {
      ...
      Event.prototype['getEvent'] = function(type) {
      ...
      Event.prototype['getSubscribers'] = function(type) {
        return this.eventMap[type] && this.eventMap[type].subscribers;
      };
      Event.prototype['initEvent'] = function(type,name,event) {
        event.type=name;
        if(type == 'Event') {
        }
        if(type === 'MouseEvent') {
      ...
      Event.prototype['isCustomEvent'] = function(type) {
        if(typeof((this.eventNameToEventClassNameMap[type])) !== 'undefined') {
          return false;
        }
        return true;
      };
      Event.prototype['rebuild'] = function() {
        try {
      ...
      Event.prototype['register'] = function(type,eventType) {
        try {
      ...
      Event.prototype['removeSubscriber'] = function() {
        if(typeof((arguments[0])) == 'string' && arguments[0].charAt(0) == '/') {
          this.removeSubscriberFromChannel.apply(this,arguments);
        }
        this.removeSubscriberFromEvent.apply(this,arguments);
      };
      Event.prototype['removeSubscriberFromEvent'] = function(type,callback,useCapture,element) {
        (element || window).removeEventListener(type,callback,useCapture);
        return true;
      };
      Event.prototype['removeSubscriberFromChannel'] = function(type,callback) {
        var eventInfo=this.eventMap[type];
        if(eventInfo) {
          var newSubscribers=[];
          var found=false;
      ...
      Event.prototype['validate'] = function(message) {
        var instance;
...
(function() {
  ...
  (function(require, exports, moduleId) {
    ...
    var ControllerType = (function() {
      ...
      ControllerType.prototype['connect'] = function(_properties) {
        var properties = _properties || {};
        try {
          this.wsLocation=properties.location;
          this.dispatcher=MozWebSocket?new MozWebSocket(this.wsLocation):new WebSocket(this.wsLocation);
